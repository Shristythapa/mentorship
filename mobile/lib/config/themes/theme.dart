import 'package:app/config/constants/theme_constant.dart';
...
ThemeData getApplicationTheme(bool isDark) {
  return ThemeData(
    ...
    primaryColorLight: isDark ? Colors.white : const Color(0xFF772C91),
    ...
    textTheme: TextTheme(
      ...
      titleMedium: isDark
          ...
          : const TextStyle(
              color: Color(0xFF772C91),
              fontFamily: 'nunitoSans',
            ),
      headlineLarge: const TextStyle(
          color: Color(0xFF9A9A9A), fontSize: 12, fontFamily: 'nunitoSans'),
      headlineMedium: const TextStyle(
          color: Color(0xFF772C91), fontSize: 10, fontFamily: 'nunitoSans'),
