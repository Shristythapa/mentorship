...
class MentorForgotPassword extends ConsumerStatefulWidget {
  const MentorForgotPassword({super.key});

  @override
  ConsumerState<MentorForgotPassword> createState() =>
      _MentorForgotPasswordState();
}

class _MentorForgotPasswordState extends ConsumerState<MentorForgotPassword> {
  bool buttonPressed = false;

  String email = '';
  TextEditingController emailController =
      TextEditingController(text: "testing99st@gmail.com");
  ...
  Widget build(BuildContext context) {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (forgotPasswordState.showMessage != null &&
          forgotPasswordState.showMessage!) {
